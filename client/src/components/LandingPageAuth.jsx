...
import { User, Car, Mail, Lock, Eye, EyeOff, Phone, MapPin, UserPlus, LogIn, ArrowRight } from 'lucide-react'

export default function LandingPageAuth({ onLogin }) {
  ...
  if (!showSignup) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-sky-50 flex">
          ...
          <div className="relative z-10 flex flex-col justify-center items-center h-full p-12 text-white">
            ...
            <div className="mt-12 space-y-4">
              <button
                ...
                className="w-full bg-white text-blue-600 py-4 rounded-lg font-semibold hover:bg-gray-100 transition flex items-center justify-center space-x-2"
              >
              ...
              <button
                onClick={() => {setShowSignup(true); setIsLogin(true)}}
                className="w-full bg-transparent border-2 border-white text-white py-4 rounded-lg font-semibold hover:bg-white hover:text-blue-600 transition flex items-center justify-center space-x-2"
              >
        ...
        {/* Right Side - Simple Welcome */}
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
          <div className="w-full max-w-md text-center">
            {/* Logo */}
            <div className="bg-gradient-to-r from-blue-500 to-sky-500 rounded-lg p-3 inline-block mb-6">
            ...
            <p className="text-gray-600 mb-8">
              Experience premium taxi service in Belgium. Whether you're looking to book rides or earn as a driver, we've got you covered.
            </p>

            {/* Role Cards */}
            <div className="grid grid-cols-2 gap-4 mb-8">
              <div className="bg-white rounded-xl border border-gray-200 p-6 hover:border-blue-500 transition cursor-pointer">
                <User className="h-8 w-8 text-blue-600 mx-auto mb-3" />
                <h3 className="font-semibold text-gray-900 mb-2">Passenger</h3>
                <p className="text-sm text-gray-600">Book rides and travel in comfort</p>
              </div>
              
              <div className="bg-white rounded-xl border border-gray-200 p-6 hover:border-blue-500 transition cursor-pointer">
                <Car className="h-8 w-8 text-blue-600 mx-auto mb-3" />
                <h3 className="font-semibold text-gray-900 mb-2">Driver</h3>
                <p className="text-sm text-gray-600">Earn money on your schedule</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <button
                onClick={() => setShowSignup(true)}
                className="w-full bg-gradient-to-r from-blue-500 to-sky-500 text-white py-4 rounded-lg font-semibold hover:from-blue-600 hover:to-sky-600 transition flex items-center justify-center space-x-2"
              >
                <UserPlus className="h-5 w-5" />
              ...
              <button
                onClick={() => {setShowSignup(true); setIsLogin(true)}}
                className="w-full bg-gray-100 text-gray-700 py-4 rounded-lg font-semibold hover:bg-gray-200 transition flex items-center justify-center space-x-2"
              >
                <LogIn className="h-5 w-5" />
                <span>Sign In</span>
              </button>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              {isLogin ? 'Welcome back! Please sign in to continue' : 'Join our community of riders and drivers'}
            </p>
          </div>
